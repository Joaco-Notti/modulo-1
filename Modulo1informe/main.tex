...
\section{Conclusión}
La adopción de $\text{\LaTeX}$, HTML y Markdown ha transformado mi flujo de trabajo, permitiéndome migrar de una edición intuitiva a una gestión documental programada. Este cambio garantiza una separación rigurosa entre la lógica del contenido y su representación visual, logrando una precisión estructural que los procesadores convencionales no pueden alcanzar.
En el ejercicio de la Ingeniería Industrial, estas herramientas serán determinantes. Implementaré $\text{\LaTeX}$ como eje para la producción de informes técnicos y documentación de proyectos, asegurando rigor estético y normativo. Paralelamente, la versatilidad de Markdown y HTML facilitará la digitalización y distribución estratégica de mis recursos académicos, optimizando su legibilidad en entornos web y facilitando su escalabilidad como productos de información.
A continuación, se presenta la comparativa técnica elaborada con asistencia de IA que resume esta transición:
...
\hline
Dependencia exclusiva de procesadores de texto visuales (WYSIWYG) con formatos inestables. & Habilidades de produccion de  documentos de calidad  con \LaTeX{}. \\
\hline
Dificultad para integrar y dar formato legible a bloques de código fuente. & Optimización de la legibilidad de código a través del entorno \texttt{listings} logrando una integración fluida y estilizada del software en el texto.. \\
\hline
Desconocimiento de la estructura semántica de los documentos web. & Dominio de la arquitectura de contenidos basada en HTML5 semántico y flujo de trabajo eficiente con sintaxis Markdown. \\
\hline
Gestión manual y propensa a errores de referencias cruzadas y bibliografía. & Sistematización de la gestión documental mediante bases de datos . \texttt{.bib}. automatizando el referenciado dinámico y el estilo bibliográfico. \\
\hline
\end{tabular}
\end{table}
